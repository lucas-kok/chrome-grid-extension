(() => {
	...
	function handleKeyDown(e) {
		// Shortcuts: Alt + Shift + V, Alt + Shift + H, etc.
		// Ctrl + Shift + B conflicts with Bookmarks bar
		// Ctrl + Shift + M conflicts with Profile switcher
		// Ctrl + Shift + V conflicts with Paste as plain text
